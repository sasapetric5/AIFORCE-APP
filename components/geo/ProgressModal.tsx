...
export const ProgressModal: React.FC<ProgressModalProps> = ({ isOpen, onClose, title, isLoading, content }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl shadow-2xl max-w-2xl w-full flex flex-col max-h-[90vh]"
